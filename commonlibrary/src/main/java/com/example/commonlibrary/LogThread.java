...
//    public static String logFilePath = Environment.getExternalStorageDirectory() + "/clzxLog/";
    ...
    //日志文件名
    public static String logFileName = "CLZX_APP_" + Utils.getNowTimeDay() + ".log";
    private String oldLogFileName = "CLZX_APP_" + Utils.getTimeDay(Utils.getYesterdayTimestamp()) + ".log";
    //日志文件大小上限 单位KB
